...
otpt_target = 397 * psi  # in psig, target lox tank pressure
...
FMV_time = 500  # observed FMV actuation time in milliseconds (NEED)
OMV_time = 506  # observed OMV actuation time in milliseconds
